#!/home/n8n-admin/.venv/bin/python
"""
Gets user role assignments in a given scope

snippets used from
https://github.com/Azure-Samples/azure-samples-python-management/blob/main/samples/authorization/
"""
import os
