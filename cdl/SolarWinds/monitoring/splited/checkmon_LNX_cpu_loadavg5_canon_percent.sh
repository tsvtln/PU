...
echo "Statistic:$cpu_loadavg5_canon_percent"
echo "Message: CPU canon average load last 5minutes: $cpu_loadavg5_canon_percent.
 CPU average load: $cpu_loadavg5. Number of cores on this node is $cpu_nb." |tr -d '\n'|paste -sd ''
