...
class Updater:
    ...
    def run_updates(self) -> None:
        ...
        self.print("Getting checksum of files...")

        # Use the uploaded path if provided, otherwise use the default
        if self.uploaded_path:
            original_path = GlobalVars.solarwinds_fileshare_path
            GlobalVars.solarwinds_fileshare_path = self.uploaded_path
            self.print(f"Calculating checksums from: {self.uploaded_path}")
        else:
            original_path = None
            self.print(f"Calculating checksums from: {GlobalVars.solarwinds_fileshare_path}")
        ...
        try:
            ...
            if original_path:
                GlobalVars.solarwinds_fileshare_path = original_path
        ...
        self.print(f"Version in nuspec updated to {GlobalVars.solarwinds_version}")
        self.print("=" * 50)
